    ...
    return Row(
      ...
      children: <Widget>[
        ...
        StreamBuilder<DateTime?>(
            stream: instance.getLastShowerTime(instance),
            builder: (context, AsyncSnapshot<DateTime?> snapshot) {
              return GestureDetector(
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 20.0),
                  child: Image.asset(
                    'lib/images/purpleSoap.png',
                    height: MediaQuery.of(context).size.height *
                        0.20, // Adjust this value to fit your needs
                    width: MediaQuery.of(context).size.width * 0.20,
                  ),
                ...
                onTap: () {
                  animationNotifier.updateAnimationOnShowerTap(() {
                    debugPrint("last shower time " + snapshot.data.toString());
                    ...
                    body: Stack(
                      children: <Widget>[
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image:
                                  AssetImage('lib/images/bathroomNoBath.png'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                        ...
                        Positioned(
                          ...
                          bottom: 20,
                          child: CarrotArrows(
                            nextPage: Kitchenscreen(),
                            previousPage: BedroomScreen(),
                          ),
                        ),
                      ],
                    ),
