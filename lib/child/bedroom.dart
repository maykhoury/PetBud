    ...
    return Row(
      ...
      children: <Widget>[
        ...
        StreamBuilder<DateTime?>(
            stream: instance.getLastSleepTime(instance),
            builder: (context, AsyncSnapshot<DateTime?> snapshot) {
              return GestureDetector(
                child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 20.0),
                  child: Image.asset(
                    'lib/images/orangeSleep.png',
                    height: MediaQuery.of(context).size.height *
                        0.20, // Adjust this value to fit your needs
                    width: MediaQuery.of(context).size.width * 0.20,
                  ),
                ...
                onTap: () {
                  animationNotifier.updateAnimationOnSleepTap(() {
                      ...
                      builder: (BuildContext context) {
                        ...
                        switch (stars) {
                          case 1:
                            ...
                            break;
                          case 2:
                            starImage = 'lib/images/twoStars.png';
                            break;
                          case 3:
                    ...
                    body: Stack(
                      children: <Widget>[
                        Container(
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage('lib/images/Bedroom.png'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding:
                                        const EdgeInsets.fromLTRB(15, 25, 10, 10),
                                    child: Column(
                                      children: <Widget>[
                        ...
                        Positioned(
                          ...
                          bottom: 10,
                          child: CarrotArrows(
                            nextPage: BathroomScreen(),
                            previousPage: Kitchenscreen(),
                          ),
                        ),
                        Positioned(
                          left: 0,
                          ...
                          child: MedicineButton(
                            all_med_times: snapshot1.data!,
                            last_medicine_time: last_medicine_snapshot.data!,
                          ),
                        )
                      ],
                    ),
